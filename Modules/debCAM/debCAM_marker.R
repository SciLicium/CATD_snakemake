...
if (filename_P != 'Modules/Pseudobulk/dummy_props.rds') MGlist <- MGlist[order(match(names(MGlist), rownames(P)))] #Makes sure list order is same as rownames(P) for future metrics
